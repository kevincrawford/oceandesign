class GridFlyover extends Controller
		...
		@configs =[
			{
				name: "Active"
				columns: [
					{ index: "FleetId", title: "Fleet", hiddenDisplayed: true }
					{ index: "JobTitle", title: "Job Title", hiddenDisplayed: true }
			...
			}
			{
				...
				columns: [
					{ index: "FleetId", title: "Fleet", hiddenDisplayed: true }
					{ index: "DivisionCd", title: "Division", hiddenDisplayed: true }
